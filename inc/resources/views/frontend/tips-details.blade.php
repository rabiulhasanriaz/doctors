		...
		<section class="bottom-banner-w3layouts py-5" id="about">
            ...
            <div class="container py-xl-5 py-lg-3">
                <div class="row py-xl-3 py-lg-3">
                    <div class="col-md-12">
                        <img style='float:left;width:200px;height:200px; margin-right:10px;' src="{{ $tip->image ?? asset('assets/images/about.jpg')}}" />
                        <h3 class="title-wthree text-dark mb-4">
                            <span class="mb-2">Some Info</span>{{ $tip->title ?? 'No Title'}}</h3>
                        <p class="mt-3" style="color: black;">{{ $tip->context ?? 'No Details' }}</p>
                    </div>
                </div>
            </div>
        </section>
